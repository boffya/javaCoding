 ...
 * @Author sunc
 * @Description TODO
 * @info com.suncor.coding.string ReceiptBuilder2 2020/5/19 11:14
 */
public class ReceiptBuilder2 {
    private double total = 0;
    private Formatter f =
            new Formatter(new StringBuilder());

    public ReceiptBuilder2() {
        f.format(
    ...
    public static void main(String[] args) {
        ReceiptBuilder2 receiptBuilder = new ReceiptBuilder2();
